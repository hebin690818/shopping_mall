...
export default function PaymentSuccessPage({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-100 via-white to-white pb-12">
      <div className="px-4 pt-8 flex items-center gap-3">
        <button
          type="button"
        ...
        <div className="text-lg font-semibold text-slate-900">支付成功</div>
      </div>
      ...
      <div className="px-4 mt-8 space-y-6">
        <div className="bg-white rounded-3xl p-8 text-center shadow-sm space-y-4">
          ...
          <Paragraph className="!mb-0 text-slate-500">订单正在处理中，稍后可在订单页查看详细物流信息。</Paragraph>
